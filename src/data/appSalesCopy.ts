...
// Extended format for product detail modals (concise LLM-generated)
...
// Extended sales data (will be generated by LLM script)
export interface ExtendedAppSalesData {
  [appId: string]: ExtendedSalesCopy;
}

// Import will be added after generation
declare const extendedSalesCopy: ExtendedAppSalesData;
...
export const appSalesCopy: AppSalesData = {
  'email-gtm-agent': {
    ...
    whatItDoes: 'Automatically researches target companies and decision-makers, then generates personalized sales emails tailored to department and campaign type.',
    howItMakesMoney: 'Subscription model: $79/month for unlimited email generation with full research integration. Includes access to Exa AI search for real-time company intelligence.',
    whyBusinessesNeedIt: 'Sales development reps spend 60% of their time on research. This tool automates that work, delivering personalized outreach emails in seconds instead of hours. Scale your outbound without hiring more SDRs.'
  },
  'financial-coach': {
    tonality: 'Trusted Advisor',
    whatItDoes: 'AI-powered personal finance coach that analyzes income/expenses, categorizes spending, and provides actionable recommendations for budgeting, saving, and debt reduction.',
  ...
  'reasoning-agent': {
    ...
    howItMakesMoney: 'Charge $29/month for access to unlimited reasoning comparisons. Perfect for students, educators, and AI enthusiasts.',
    whyBusinessesNeedIt: 'Understanding AI reasoning capabilities helps build better prompts and trust in AI outputs. This tool makes AI thinking transparent and educational.'
  },
  'finance-agent': {
    tonality: 'Financial Advisor',
    whatItDoes: 'Provides real-time stock analysis, portfolio tracking, and AI-generated investment insights with confidence scores.',
    howItMakesMoney: 'Subscription model: $49/month for individual investors, $199/month for financial advisors managing multiple client portfolios.',
    whyBusinessesNeedIt: 'Most investors make decisions based on emotion or incomplete information. This tool provides data-driven analysis, risk assessment, and objective recommendations to improve investment outcomes.'
  },
  'web-scraping-agent': {
    tonality: 'Technical Educator',
    whatItDoes: 'Uses AI to extract structured data from websites via natural language prompts. Supports extraction, summarization, Q&A, and listing modes.',
    howItMakesMoney: 'Tiered pricing: $39/month for 100 scrapes, $99/month for 500 scrapes, $299/month for unlimited. Perfect for market researchers, lead gen, and data analysts.',
    whyBusinessesNeedIt: 'Manual data collection is tedious and error-prone. This tool lets anyone extract exactly what they need from any site using plain English, democratizing web data access.'
  },
  'salesforce-ai': {
    tonality: 'Challenger Sale',
    whatItDoes: 'Generates comprehensive sales battle cards with real-time competitor research, SWOT analysis, objection handling scripts, and visual feature comparisons.',
    howItMakesMoney: 'Charge sales teams and managers $500-2000 per battle card, targeting B2B sales organizations competing against major players like Salesforce, HubSpot, and Slack.',
    whyBusinessesNeedIt: 'Your sales reps are losing deals because they\'re unprepared. This tool gives them the intelligence edge—real competitor data, proven objection responses, and professional battle cards that close more deals.'
  },
  'launchrocket-ai': {
    tonality: 'Strategic Advisor',
    whatItDoes: 'Provides comprehensive product launch intelligence with competitor analysis, market sentiment tracking, performance metrics, and strategic GTM recommendations for successful product launches.',
    howItMakesMoney: 'Charge product managers and GTM teams $800-3000 per launch analysis, targeting B2B SaaS companies and startups planning major product launches.',
    whyBusinessesNeedIt: '70% of product launches fail due to poor market intelligence. This AI system gives you the strategic insights, competitive positioning, and market validation needed to launch successfully and capture market share.'
  },
  'consultpro-ai': {
    tonality: 'Executive Consultant',
    whatItDoes: 'Delivers comprehensive business consultation with real-time market research, strategic planning, risk assessment, and detailed implementation roadmaps for critical business decisions.',
    howItMakesMoney: 'Charge entrepreneurs and business leaders $500-2000 per consultation, targeting startups, small businesses, and executives needing expert strategic guidance at a fraction of traditional consulting costs.',
    whyBusinessesNeedIt: 'Business owners make million-dollar decisions with limited information. This AI consultant provides the market intelligence, strategic analysis, and implementation expertise that would cost $10,000+ from human consultants.'
  },
  'podcastify-ai': {
    tonality: 'Creative Producer',
    whatItDoes: 'Transforms blog posts into professional podcast episodes with AI-powered content analysis, script generation, and engaging narration that converts written content into audio experiences.',
    howItMakesMoney: 'Charge content creators and marketers $200-800 per podcast episode, targeting bloggers, thought leaders, and brands wanting to repurpose content into multiple formats.',
    whyBusinessesNeedIt: 'Written content reaches 30% fewer people than audio. This tool turns your blog posts into podcast episodes instantly, expanding your audience reach and content lifecycle without additional production costs.'
  },
  'socialbuzz-ai': {
    tonality: 'Social Strategist',
    whatItDoes: 'Provides comprehensive social media intelligence with real-time sentiment analysis, trending topics identification, engagement metrics, and strategic recommendations for social media success.',
