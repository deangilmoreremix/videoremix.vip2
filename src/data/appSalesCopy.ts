...
export const appSalesCopy: AppSalesData = {
  ...
  "travel-concierge-ai": {
    tonality: "Value-Based",
    whatItDoes: "Acts as your always-on personal travel concierge that generates ideas, full itineraries, booking advice, reminders, and live adjustments from your preferences and real-time data.",
    howItMakesMoney: "Offer premium travel planning services for $97-$297 per trip or as a subscription for frequent travelers and agencies.",
    whyBusinessesNeedIt: "Travel planning is time-consuming and error-prone. This tool delivers measurable value by turning hours of research into instant, personalized, bookable plans that increase satisfaction and repeat business."
  },
  "email-memory-assistant": {
    tonality: "Challenger Sale",
    whatItDoes: "Builds a living, queryable memory from all your email threads so you never forget what was said, who promised what, or what actions are pending.",
    howItMakesMoney: "Sell as a productivity tool for $97 lifetime or $29/mo to professionals, executives, and teams who live in email.",
    whyBusinessesNeedIt: "Email is the primary business record but impossible to search effectively. The assumption that you can just search Gmail is broken. This challenges that by giving you true organizational memory that surfaces action items, commitments, and history instantly."
  },
  "browser-task-agent": {
    tonality: "Value-Based",
    whatItDoes: "Turns any browser-based goal into a complete, research-backed, step-by-step action plan with live data, exact clicks/searches needed, and extracted facts.",
    howItMakesMoney: "Offer research + execution services for $97–$297 per complex browser task or as a monthly retainer for agencies and power users.",
    whyBusinessesNeedIt: "Manual browser work is slow, inconsistent, and expensive. This tool delivers measurable value by compressing hours of research and clicking into minutes of high-quality, actionable output that teams can execute immediately."
  },
  "ai-tool-router": {
    tonality: "Challenger Sale",
    whatItDoes: "Analyzes your goal and intelligently routes you to the single best (or optimal short sequence of) apps inside the 95-app Internal AI Suite, complete with ready-to-paste, goal-specific prompts.",
    howItMakesMoney: "Charge $97 lifetime or $29/mo as the meta-orchestrator that makes the entire suite 10x more usable and discoverable.",
    whyBusinessesNeedIt: "Having 95 powerful tools is useless if people cannot find the right one. The assumption that users will magically pick the best app is false. This challenges that by giving instant, expert-level routing plus perfect prompts — turning a confusing catalog into a superpower."
  }
};
