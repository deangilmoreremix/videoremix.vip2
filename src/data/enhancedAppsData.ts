...
export const enhancedAppDetails: Record<string, any> = {
  ...
  "ai-skills-monetizer": {
    longDescription:
      "Transform your expertise into a profitable online business with AI-powered tools that help you create, package, and sell your skills. From course creation to consulting services, monetize what you know with intelligent automation.",
    benefits: [
    ...
    steps: [
      {
        ...
        description:
          "Tell the AI about your skills, experience, and who you want to help",
      },
      {
        title: "Create Your Offer",
        description:
          "AI helps structure your knowledge into courses, coaching, or consulting packages",
      },
      {
        title: "Set Up Marketing",
        description:
          "Generate landing pages, email campaigns, and promotional materials automatically",
      },
      {
        title: "Launch & Grow",
        description:
          "Start accepting clients and let AI optimize pricing and marketing based on performance",
      },
    ],
    useCases: [
      {
    ...
    testimonials: [
      {
        quote:
          "I built and launched my first course in 5 days. The AI helped me organize my messy knowledge into a structured program. Made $12K in the first month!",
      ...
      {
        quote:
          "As a freelancer, I always struggled with productizing my services. This tool helped me create three different coaching packages, and I've tripled my income.",
        name: "Robert Chang",
    ...
    faqs: [
      {
        ...
        answer:
          "No! Our platform is designed for non-technical users. The AI handles the complex parts of course creation, and you focus on sharing your knowledge.",
      },
      {
        question: "How does the pricing optimization work?",
        answer:
          "The AI analyzes similar offerings in your niche, considers your experience level, and tests different price points to find the optimal rate that maximizes both conversions and revenue.",
      },
      {
        question: "Can I use my own payment processor?",
        answer:
          "Yes! While we offer integrated payment processing through Stripe, you can also connect PayPal, or use our checkout links with your preferred payment system.",
      },
      {
        question: "What if I don't have a large audience yet?",
        answer:
          "The tool includes AI-powered marketing systems that help you build an audience through content creation, social media automation, and targeted advertising campaigns.",
      },
    ],
    tags: [
      "Monetization",
  ...
  "funnelcraft-ai": {
    longDescription:
      "Build high-converting sales funnels with AI-powered optimization. From landing pages to checkout flows, create complete customer journeys that maximize conversions. Perfect for marketers, entrepreneurs, and businesses scaling their online sales.",
    benefits: [
    ...
    steps: [
      {
        ...
        description:
          "Input product details, pricing, and target audience information",
      },
      {
        title: "Choose Funnel Type",
        description:
          "Select from templates: lead magnet, webinar, product launch, or custom",
      },
      {
        title: "AI Builds Pages",
        description:
          "AI generates landing pages, thank you pages, and follow-up sequences",
      },
      {
    ...
    useCases: [
      {
        ...
        description:
          "Sell courses, ebooks, and software with optimized funnels",
        points: [
    ...
    testimonials: [
      {
        quote:
          "Our conversion rate jumped from 2.3% to 8.7% after rebuilding our funnel with FunnelCraft AI. The automated testing found winners we never would have discovered.",
      ...
      {
        quote:
          "Built and launched a complete sales funnel in 2 days. Made our first sale within hours of going live. The AI's copy suggestions were better than what our copywriter produced.",
        name: "Lisa Chen",
    ...
    faqs: [
      {
        ...
        answer:
          "No! The platform is completely no-code. The visual builder is intuitive, and AI handles the technical optimization automatically.",
      },
      {
        question: "Can I use my own domain?",
        answer:
          "Yes! You can connect custom domains to your funnels. We provide SSL certificates and handle all technical setup.",
      },
      {
        question: "How does the A/B testing work?",
        answer:
          "AI automatically creates variations of your pages and tests elements like headlines, images, CTAs, and layouts. It dynamically adjusts traffic to the best performers and implements winners automatically.",
      },
      {
        question: "What payment processors do you support?",
        answer:
          "We integrate with Stripe, PayPal, and most major payment processors. You can also use our integrated checkout or connect your existing payment system.",
      },
    ],
    tags: [
      "Sales Funnels",
