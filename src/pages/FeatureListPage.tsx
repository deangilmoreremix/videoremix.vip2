...
const additionalFeatures = [
  ...
  },
  {
    ...
    shortDescription:
      "Remove backgrounds from videos with one click, no green screen required",
    icon: "✂️",
    category: "ai",
  ...
  },
  {
    ...
    shortDescription:
      "Add professional animated elements and graphics to your videos",
    icon: "🎬",
    category: "templates",
  ...
  },
  {
    ...
    shortDescription:
      "Create individualized videos at scale with dynamic content insertion",
    icon: "👤",
    category: "workflow",
  ...
  },
  {
    ...
    shortDescription:
      "Track engagement, view rates, and conversion metrics across platforms",
    icon: "📊",
    category: "business",
  ...
  },
  {
    ...
    shortDescription:
      "Schedule and publish videos directly to all major social platforms",
    icon: "🌐",
    category: "workflow",
  ...
  },
  {
    ...
    shortDescription:
      "Optimize titles, descriptions, and tags for better discovery",
    icon: "🔍",
    category: "marketing",
    tags: ["SEO", "discovery"],
  },
  {
    ...
    shortDescription:
      "Capture high-quality screen recordings with annotation tools",
    icon: "🖥️",
    category: "workflow",
  ...
  },
  {
    ...
    shortDescription:
      "Edit footage from multiple cameras with synchronized timelines",
    icon: "📹",
    category: "advanced",
  ...
  },
  {
    ...
    shortDescription:
      "Apply professional color grades and LUTs with fine control",
    icon: "🎨",
    category: "advanced",
  ...
  },
  {
    ...
    shortDescription:
      "Improve voice clarity, reduce noise, and optimize audio levels automatically",
    icon: "🔊",
    category: "ai",
  ...
  },
  {
    ...
    shortDescription:
      "Add clickable buttons, forms, and interactive hotspots to videos",
    icon: "👆",
    category: "advanced",
...
const getAllFeatures = () => {
  ...
  const normalizedMainFeatures = featuresData.map((feature) => ({
    ...
    category: feature.id.includes("ai")
      ? "ai"
      : feature.id.includes("template")
        ? "templates"
        : feature.id.includes("repurposing")
          ? "workflow"
          : feature.id.includes("caption")
            ? "ai"
            : feature.id.includes("collaboration")
              ? "collaboration"
              : "workflow",
              ...
              >
                <MagicSparkles minSparkles={5} maxSparkles={8}>
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                    ...
                    <span className="text-primary-400">Transform</span> Your
                    Videos
                  </h1>
                </MagicSparkles>

                <p className="text-xl text-gray-300 mb-8">
                  Discover the industry-leading tools that make VideoRemix.vip
                  the ultimate platform for marketing personalization and
            ...
            {filteredFeatures.length > 0 ? (
                      ...
                      featuresData.some((f) => f.id === feature.id) ? (
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          {hoveredFeature === feature.id && (
                            ...
                            >
                              <Check className="h-3 w-3 inline mr-1 text-primary-400" />{" "}
                              Included in Pro+
                            </motion.div>
                          )}
                        </div>
              ...
              >
                ...
                <p className="text-gray-400 mb-6">
                  We couldn't find features matching "{searchQuery}"
                </p>
                <button
                  onClick={() => {
                    setSearchQuery("");
        ...
        <section className="py-20 bg-gradient-to-br from-primary-900/40 to-primary-700/40">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join thousands of creators and businesses who have
                revolutionized their workflow with VideoRemix.vip's powerful
                features.
              </p>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                VideoRemix.vip offers capabilities that outshine traditional
                marketing tools and other online platforms
              </p>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-gray-900 rounded-xl overflow-hidden shadow-xl border border-gray-800">
                ...
                <tbody>
                  {[
                    {
                      feature: "AI-powered video creation",
                      videoremix: true,
                      traditional: false,
                      online: false,
                    },
                    {
                      feature: "Automatic editing suggestions",
                      videoremix: true,
                      traditional: false,
                      online: false,
                    },
                    ...
                    {
                      feature: "Direct social publishing",
                      videoremix: true,
                      traditional: false,
                      online: true,
                    },
                    {
                      feature: "4K export quality",
                      videoremix: true,
                      traditional: true,
                      online: false,
                    },
