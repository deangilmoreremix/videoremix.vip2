...
const articles = [
  ...
  },
  {
    ...
    toc: [
      ...
      { id: 'step-1-define-your-audience-segments', title: 'Step 1: Define Your Audience Segments', level: 2 },
      { id: 'example-segments-for-beginners', title: 'Example Segments for Beginners', level: 3 },
      { id: 'step-2-choose-your-marketing-tools', title: 'Step 2: Choose Your Marketing Tools', level: 2 },
      { id: 'recommended-starting-tools', title: 'Recommended Starting Tools', level: 3 },
      { id: 'step-3-create-personalized-content', title: 'Step 3: Create Personalized Content', level: 2 },
      { id: 'landing-page-personalization', title: 'Landing Page Personalization', level: 3 },
      { id: 'video-personalization', title: 'Video Personalization', level: 3 },
      { id: 'email-personalization', title: 'Email Personalization', level: 3 },
      { id: 'step-4-review-and-launch', title: 'Step 4: Review and Launch', level: 2 },
      { id: 'step-5-monitor-and-optimize', title: 'Step 5: Monitor and Optimize', level: 2 },
