...
const AIEditingPage: React.FC = () => {
  // Find feature data
  const feature = featuresData.find(f => f.id === 'ai-editing');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI video editing, automatic color correction, scene detection, intelligent video editing, video enhancement" />
      </Helmet>
