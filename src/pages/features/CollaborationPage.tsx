...
const CollaborationPage: React.FC = () => {
  // Find feature data
  const feature = featuresData.find(f => f.id === 'collaboration');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="team collaboration, collaborative editing, version control, video team workflow, remote collaboration" />
      </Helmet>
