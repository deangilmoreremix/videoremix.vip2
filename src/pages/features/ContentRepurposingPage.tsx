...
const ContentRepurposingPage: React.FC = () => {
  // Find feature data
  const feature = featuresData.find(f => f.id === 'content-repurposing');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="content repurposing, video clips, short-form content, long-form to short-form, video transformation" />
      </Helmet>
