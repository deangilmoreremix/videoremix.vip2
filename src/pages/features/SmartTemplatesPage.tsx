...
const SmartTemplatesPage: React.FC = () => {
  // Find feature data
  const feature = featuresData.find(f => f.id === 'smart-templates');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="video templates, professional templates, video design, customizable templates, brand consistency" />
      </Helmet>
