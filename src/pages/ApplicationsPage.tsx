    ...
    <div className="min-h-screen bg-gray-900 pt-24">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            All GTM information is visible for each ai-design-studio. Sign in to access your purchased apps.
          </motion.p>
          {!user && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {apps.map((ai-design-studio, index) => {
              ...
              >
                <Card className="overflow-hidden bg-gray-800 border-gray-700 hover:border-primary-500/50 transition-all duration-300 h-full">
                  ...
                  <div className="relative aspect-video overflow-hidden">
                    <img 
                      src={ai-design-studio.image || ai-design-studio.demoImage || 'https://via.placeholder.com/400x225'} 
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center mb-2">
                      <LazyIcon name={ai-design-studio.iconName} className="w-5 h-5 text-primary-400 mr-2" />
                      <h3 className="text-lg font-bold text-white">{ai-design-studio.name}</h3>
                    </div>
                    ...
                    {ai-design-studio.benefits && ai-design-studio.benefits.length > 0 && (
                      <div className="mb-3">
                        <h4 className="text-xs font-semibold text-gray-500 uppercase mb-1">Key Benefits</h4>
                        <ul className="text-xs text-gray-400 space-y-1">
                          {ai-design-studio.benefits.slice(0, 3).map((benefit: string, i: number) => (
                    ...
                    {ai-design-studio.features && ai-design-studio.features.length > 0 && (
                      <div className="mb-3">
                        <h4 className="text-xs font-semibold text-gray-500 uppercase mb-1">Features</h4>
                        <p className="text-xs text-gray-400">
                          {ai-design-studio.features.length} feature{ai-design-studio.features.length !== 1 ? 's' : ''} included
                        </p>
                      </div>
                    )}

                    {/* GTM: Use Cases (if available) */}
                    {ai-design-studio.use_cases && ai-design-studio.use_cases.length > 0 && (
                      <div className="mb-3">
                        <h4 className="text-xs font-semibold text-gray-500 uppercase mb-1">Use Cases</h4>
                        <div className="flex flex-wrap gap-1">
                          {ai-design-studio.use_cases.slice(0, 3).map((useCase: string, i: number) => (
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-700">
                      <div>
                        <span className="text-2xl font-bold text-white">${ai-design-studio.price || 97}</span>
                        <span className="text-gray-400 text-sm ml-1">/ai-design-studio</span>
                      </div>
                      
                      <Link to={`/ai-design-studio/${ai-design-studio.id}`}>
                        <Button 
                          variant="outline" 
                          size="sm"
