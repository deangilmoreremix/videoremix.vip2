...
const _legacyTools = [
  // Content Creation
  {
    ...
    description: 'Create AI-generated images, videos, and content tailored to your brand',
    url: '/editor',
  ...
  },
  {
    ...
    description: 'Create and customize animated GIFs for social media and marketing',
    url: '/gif-editor',
  ...
  },
  {
    ...
    description: 'Transform photos into beautiful Studio Ghibli-inspired artwork',
  ...
  },
  {
    ...
    description: 'Translate proposals while preserving industry-specific terminology',
...
const featuredCollections = [
  ...
  },
  {
    ...
    tools: ['smart-crm-closer', 'funnelcraft-ai', 'sales-assistant-app', 'ai-referral-maximizer'],
              ...
              >
                <MagicSparkles minSparkles={5} maxSparkles={8}>
                  <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                    Explore Our <span className="text-primary-400">Personalized Tools</span>
                  </h1>
                </MagicSparkles>
                
                <p className="text-xl text-gray-300 mb-8">
                  Discover powerful tools to enhance your content creation, sales, and marketing efforts
                </p>
              </motion.div>
            ...
            <div className="mb-12">
              ...
              {filteredTools.length > 0 ? (
                      ...
                      <div className="block p-6">
                          ...
                          <div>
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              {tool.popular && !tool.new && (
                                <span className="bg-yellow-600/70 text-white text-xs px-2 py-0.5 rounded">POPULAR</span>
                              )}
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                          <div className="text-gray-400 text-sm font-medium">
                            ${allTools.find(a => a.id === tool.id)?.price || 97}
                          </div>
                          {user && hasPurchased(tool.id) ? (
                            <a
                              href={tool.url}
                            ...
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                const appData = allTools.find(a => a.id === tool.id);
                                setSelectedApp({
                                  id: tool.id,
                                  name: tool.name,
                ...
                >
                  ...
                  <p className="text-gray-400 mb-6">We couldn't find any tools matching your filters</p>
                  <button 
                    onClick={() => {
                      setSearchQuery('');
                      setSelectedCategory('all');
