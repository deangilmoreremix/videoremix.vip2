          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              >
                ...
                <p className="text-xl text-gray-300 mb-8">
                  Find answers to common questions about our marketing personalization platform, tools, pricing, and how to scale your business.
                </p>
              </motion.div>
                ...
                {!searchQuery && activeCategory !== 'all' && (
                  <div className="mb-6">
                    ...
                    <p className="text-gray-300">
                      {activeCategory === 'getting-started' && "Everything you need to know to get started with personalized marketing on VideoRemix.vip."}
                      {activeCategory === 'accounts' && "Information about accounts, subscriptions, billing, and payments."}
                      {activeCategory === 'features' && "Learn about our 37+ marketing tools, audience segmentation, and personalization capabilities."}
                      {activeCategory === 'technical' && "Technical specifications, integrations, and platform requirements."}
                      {activeCategory === 'collaboration' && "How to work with team members, manage clients, and scale your agency."}
                      {activeCategory === 'security' && "Details about our privacy practices and security measures."}
                      {activeCategory === 'ai' && "Learn how our AI-powered personalization features work to boost your marketing results."}
                      {activeCategory === 'publishing' && "Information about exporting, scheduling, and distributing your marketing content."}
                      {activeCategory === 'templates' && "All about our templates, tools, and content library."}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Create personalized marketing campaigns with our AI-powered platform and 37+ specialized tools.
              </p>
              ...
              <p className="mt-4 text-gray-400">No credit card required. Start with our Free plan or upgrade anytime.</p>

              {/* Key features */}
              <div className="mt-12 flex flex-wrap justify-center gap-4">
                {[
                  { icon: <Zap className="h-4 w-4" />, text: "AI-powered personalization" },
                  { icon: <Clock className="h-4 w-4" />, text: "Create campaigns in minutes" },
                  { icon: <Video className="h-4 w-4" />, text: "37+ marketing tools" },
                  { icon: <Database className="h-4 w-4" />, text: "Audience segmentation" },
                  { icon: <Users className="h-4 w-4" />, text: "Agency & team features" },
                  { icon: <Globe className="h-4 w-4" />, text: "Multi-channel campaigns" }
                ].map((feature, index) => (
                  <div
                    key={index}
