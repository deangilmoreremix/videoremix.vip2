    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/70 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
        ...
        <ul className="text-sm text-gray-300 space-y-2 list-disc list-inside">
          ...
          <li>The system will automatically create user accounts for new customers</li>
          <li>Purchases will be matched to product catalog and app access will be granted</li>
          <li>Monthly subscriptions will have expiration dates calculated automatically</li>
          <li>Refunded and pending transactions will be skipped or marked accordingly</li>
