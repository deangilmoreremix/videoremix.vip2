...
const caseStudies: CaseStudyType[] = [
  {
    ...
    testimonial: {
      quote:
        "The difference in our marketing performance is night and day. We now produce segment-specific fashion videos in minutes that connect with each audience perfectly. Our marketing ROI increased over 5x.",
  ...
  },
  {
    ...
    solution:
      "Implemented role-based video personalization for different decision-makers (CTO, CFO, end users). Created industry-specific templates with VideoRemix.vip's AI personalization that sales teams could customize in minutes.",
    results: [
      {
  ...
  },
  {
    ...
    solution:
      "Implemented personalized course introduction videos based on learning preference profiles and previous course history. Used VideoRemix.vip to create adaptive learning path videos that change based on student progress.",
    results: [
      {
    ...
    testimonial: {
      quote:
        "Personalized learning videos have revolutionized our student experience. By tailoring course content to individual learning styles, we've seen extraordinary improvements in completion rates and student satisfaction.",
  ...
  },
  {
    ...
    solution:
      "Developed a personalized client communication system using VideoRemix.vip that automatically creates portfolio review videos customized to each client's specific financial situation, goals, and preferences.",
    results: [
      {
    ...
    testimonial: {
      quote:
        "Our clients now receive quarterly video updates that speak directly to their specific financial situation. This personalized approach has strengthened client relationships and dramatically improved retention and referrals.",
  ...
  },
  {
    ...
    solution:
      "Implemented personalized patient education videos based on procedure type, patient age, medical history, and learning preferences using VideoRemix.vip's healthcare personalization features.",
    results: [
      {
    ...
    testimonial: {
      quote:
        "The personalized patient education videos have transformed our care delivery. Patients are better prepared for procedures and more compliant with post-care instructions, leading to significantly improved outcomes.",
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    <h4
                      className={`font-bold truncate ${activeCaseStudy === index ? "text-white" : "text-gray-300"}`}
                    >
                      {study.company}
                    </h4>
              ...
              <div>
                ...
                <div className="mb-8">
                  <div className="mb-6">
                    ...
                    <motion.p className="text-gray-300" whileHover={{ x: 5 }}>
              ...
              <div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {caseStudies[activeCaseStudy].results.map(
                      (result, index) => (
                        <motion.div
                          key={index}
                          whileHover={{
                        ...
                        >
                          <div className="flex items-start">
                            <div
                              className={`bg-gray-900 p-2 rounded-lg mr-3 ${result.color}`}
                            >
                              {result.icon}
                            </div>
                            <div>
          ...
          >
            ...
            <div className="mt-6 text-center">
              <motion.a
                ...
                whileHover={{ scale: 1.05, x: 5 }}
              >
                Download the complete {industryMetrics[activeIndustry].industry}{" "}
                benchmark report
