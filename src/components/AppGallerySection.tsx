  ...
  return (
    <section id="tools" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        >
          <h3 className="text-2xl font-bold text-white mb-6">Featured Personalization Tools</h3>
        ...
        <div className="max-w-6xl mx-auto mb-16 relative" ref={containerRef}>
          ...
          <div className="overflow-x-auto pb-6 hide-scrollbar relative" style={{ scrollbarWidth: 'none' }}>
