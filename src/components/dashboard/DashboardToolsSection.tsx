...
import { Video, Users, Image as ImageIcon, Sparkles, Palette, CircleUser as UserCircle, Package, Layers, FileText, Mic, Search, ArrowRight, ListFilter as Filter, Play, Star, PanelTop, Zap, Camera, Share, Wand as Wand2, Globe, MessageSquare, Brain, FileVideoCamera as FileVideo, ShoppingCart, Lock, Check } from "lucide-react";
                ...
                {filteredApps.map((app) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={
                          viewMode === "grid" ? "p-4" : "p-4 flex-grow"
                        }
                      >
