...
export default function PersonalizerDialog({
  ...
  const downloadReport = (format: string) => {
    ...
    let content = '';
    let filename = `videoremix_personalization_report_${targetName}_${new Date().toISOString().split('T')[0]}`;
    ...
    switch (format) {
      ...
      case 'html':
        content = `<!DOCTYPE html><html><head><title>VideoRemix Personalization System™ Report - ${targetName}</title>
            ...
            <div className="flex-1 p-6 overflow-y-auto font-body">
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  <p className="text-gray-300 font-body">Public profile scan using VideoRemix Personalization System™</p>
