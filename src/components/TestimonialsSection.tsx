      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {[
              {
                award: "Video Innovation Award 2024",
                organization: "Digital Media Alliance",
              },
              {
                award: "Best AI-Driven Product",
                organization: "Tech Innovator Awards",
              },
              {
                award: "Top Creator Tool",
                organization: "Content Creator Summit",
              },
              {
                award: "Most User-Friendly Video Platform",
