    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 break-words">
              Choose Your{" "}
              <span className="text-primary-400">VideoRemix Plan</span>
            </h2>
          </MagicSparkles>

          <p className="text-xl text-gray-300 mb-4 break-words">
            Select the plan that fits your personalized marketing needs.
          ...
          <div className="flex justify-center mb-8 mt-8">
            <div className="bg-gray-800 p-1 rounded-full inline-flex">
              ...
              >
                Yearly{" "}
                <span className="text-xs bg-green-500 text-white px-1 py-0.5 rounded-sm ml-1">
                  Save 20%
                </span>
              </motion.button>
              <motion.button
              ...
              >
                Lifetime{" "}
                <span className="text-xs bg-pink-500 text-white px-1 py-0.5 rounded-sm ml-1">
                  Best Value
                </span>
              </motion.button>
            </div>
                  ...
                  <div className="mb-6">
                    ...
                    {billingCycle === "yearly" && (
                      <div className="text-sm text-gray-500">
                        ...
                        {Math.round(popularPlan.price_yearly / 12)}/mo)
                      </div>
                    )}
                    {billingCycle === "lifetime" && (
                      <div className="text-sm text-gray-500">
                ...
                <div className="lg:w-3/5 lg:pl-8">
                  <div className="mb-6">
                    ...
                    >
                      ...
                      <span className="font-bold text-lg text-white break-words">
                        INCLUDES:
                      </span>
                    </motion.div>
                    ...
                    <div className="space-y-3">
                      <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
                        <div className="font-medium text-white break-words mb-1">
                          Priority Support
                        </div>
                      ...
                      <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
                        ...
                        <p className="text-sm text-gray-400 break-words">
                          Access new features and improvements as they're
                          released
                        </p>
                      </div>
                      <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
                        ...
                        <p className="text-sm text-gray-400 break-words">
                          Comprehensive guides and tutorials to master
                          VideoRemix
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {Array.isArray(popularPlan.features) &&
                        popularPlan.features.map((feature, i) => (
                          <motion.div
                            key={i}
                            className="flex items-start"
                            whileHover={{
        ...
        >
          ...
          >
            <span className="mr-2">
              {showAllFeatures ? "Hide" : "Show"} Full Feature Comparison
            </span>
            <motion.div
            ...
            <div className="p-6">
              <div className="space-y-4">
                {restrictedFeatures.map((feature, i) => (
                  ...
                  >
                    <div className="col-span-4 text-gray-300 break-words">
                      {feature}
                    </div>
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-300">
                      Pay once, use forever – no more recurring charges
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">
                      Significant cost savings compared to yearly plans after 3
                      years
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">
                      Access to all current features and tools in your plan
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-300">
                      Free major updates for the lifetime of the product
                    </span>
                  </li>
                </ul>
                <motion.a
