...
const AppDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    let enhancedApp = foundApp ? getEnhancedAppData(appId || '', foundApp) : null;
  ...
  if (!app) {
    return (
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-gray-300 mb-8">The app you're looking for doesn't exist or has been moved.</p>
        <Link 
          to="/" 
    ...
    <div className="pt-32 pb-20">
            ...
            <div className="lg:w-1/2">
              ...
              >
                ...
                <div className="flex flex-wrap gap-6">
                  {[
                    { icon: <Users className="h-5 w-5 text-primary-400" />, label: "10,000+ active users" },
                    { icon: <Star className="h-5 w-5 text-yellow-400 fill-yellow-400" />, label: "4.9/5 rating" },
                    { icon: <Clock className="h-5 w-5 text-green-400" />, label: "Save 5+ hours per project" }
                  ].map((item, index) => (
                    <motion.div 
                      key={index} 
                    ...
                    >
                      ...
                      <span className="ml-2 text-gray-300 text-sm">{item.label}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="mt-6 flex space-x-2">
                  ...
                  >
                    <Heart className={`h-5 w-5 ${isLiked ? 'fill-primary-500' : ''}`} />
                  </motion.button>
          ...
          <div className="overflow-x-auto no-scrollbar border-b border-gray-800">
            <div className="flex space-x-8 min-w-max py-2">
              {[
                ...
                { id: 'how-it-works', label: 'How It Works', icon: <Zap className="h-4 w-4" /> },
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <motion.div
                ...
                className="mb-16"
              >
                <h2 className="text-3xl font-bold text-white mb-6 break-words">About {app.name}</h2>
                <p className="text-xl text-gray-300 mb-8 leading-relaxed break-words">
                  {app.description} With {app.name}, you can create professional-quality content in minutes instead of hours, 
                  without requiring any technical expertise or expensive equipment. Our innovative AI-powered platform 
                  handles the complex aspects of video creation so you can focus on what matters most - your message and creativity.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                  ...
                  // @ts-expect-error
                    ...
                    >
                      ...
                      <span className="text-gray-300 text-lg break-words">{benefit}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="bg-gradient-to-br from-primary-900/40 to-primary-700/40 rounded-xl border border-primary-500/30 p-8 text-center relative overflow-hidden">
                  ...
                  {/* Content */}
                  <h3 className="text-2xl font-bold text-white mb-4 break-words relative z-10">Ready to try {app.name}?</h3>
                  <p className="text-xl text-gray-300 mb-6 break-words relative z-10">
                    Join thousands of creators who are already using {app.name} to transform their video content.
                  </p>
                  <motion.button
                    whileHover={{ 
                      scale: 1.05, 
                        ...
                        <div className="flex flex-col md:flex-row md:items-center">
                          ...
                          <div className="md:w-3/4 md:pl-6">
                            ...
                            <blockquote className="text-xl text-white italic mb-4 break-words relative">
                              <span className="absolute -left-2 -top-2 text-primary-400/20 text-4xl font-serif">"</span>
                              <span className="relative z-10">{testimonial.quote}</span>
                              <span className="absolute -right-2 bottom-0 text-primary-400/20 text-4xl font-serif">"</span>
                            </blockquote>
                            <div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-300 break-words">
                Explore the innovative capabilities that make {app.name} an essential tool in your creative arsenal.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {(app.features || [
                {
                  ...
                  description: "Create professional videos automatically with our advanced artificial intelligence technology",
                  icon: React.createElement(Sparkles)
                },
                {
                  title: "Intuitive Interface",
                  description: "Easy-to-use controls designed for non-technical users to create stunning videos",
                  icon: React.createElement(Zap)
                },
                {
                  title: "Time-Saving Automation",
                  description: "Reduce video production time by up to 90% with intelligent automation features",
                  icon: React.createElement(Clock)
                },
                {
                  title: "Professional Templates",
                  description: "Choose from hundreds of professionally designed templates for any purpose",
                  icon: React.createElement(Award)
                },
                {
                  title: "Multi-Platform Optimization",
                  description: "Automatically format your videos for all major social media platforms",
              ...
              // @ts-expect-error
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-white mb-3 break-words relative z-10">{feature.title}</h3>
                  <p className="text-gray-300 break-words relative z-10">{feature.description}</p>
                </motion.div>
              ))}
            </div>
              ...
              <div className="bg-gray-800/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-gray-700 relative">
                ...
                <div className="overflow-x-auto relative z-10">
                  <table className="min-w-full divide-y divide-gray-700">
                      ...
                      <tr className="bg-gradient-to-r from-primary-900 to-primary-800">
                        ...
                        <th className="py-4 px-6 text-center text-sm font-medium text-white uppercase tracking-wider">
                          <span className="flex flex-col items-center">
                            <span className="text-lg font-bold mb-1">Traditional Editors</span>
                            <span className="text-xs text-gray-300">Adobe, Final Cut, etc.</span>
                          </span>
                        </th>
                        <th className="py-4 px-6 text-center text-sm font-medium text-white uppercase tracking-wider">
                          <span className="flex flex-col items-center">
                            <span className="text-lg font-bold mb-1">Other Online Tools</span>
                            <span className="text-xs text-gray-300">Basic web-based editors</span>
                          </span>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        { feature: "AI-powered automation", videoRemix: true, traditional: false, others: false },
                        { feature: "No technical skills required", videoRemix: true, traditional: false, others: true },
                        { feature: "Create videos in minutes", videoRemix: true, traditional: false, others: false },
                        { feature: "Professional templates", videoRemix: true, traditional: false, others: true },
                        { feature: "Multi-platform export", videoRemix: true, traditional: true, others: false },
                        { feature: "Team collaboration", videoRemix: true, traditional: true, others: false }
                      ].map((row, index) => (
                        <motion.tr 
                          key={index} 
                          ...
                          <td className="py-4 px-6 text-center">
                            {row.videoRemix ? (
                              <motion.div 
                                animate={{ 
                                  scale: [1, 1.2, 1],
                                  color: ["rgb(34, 197, 94)", "rgb(74, 222, 128)", "rgb(34, 197, 94)"]
                                }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 relative">
                ...
                {(app.steps || [
                  {
                    ...
                    description: "Select a template, start with text, or upload your own media"
                  },
                  {
                    title: "Customize Content",
                    description: "Add your text, images, and videos using our intuitive interface"
                  },
                  {
                    title: "Apply AI Enhancements",
                    description: "Let our AI optimize your content automatically for best results"
                  },
                  {
                ...
                // @ts-expect-error
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-white mb-3 pt-2 break-words">{step.title}</h3>
                    <p className="text-gray-300 break-words">{step.description}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  {app.useCases.map((useCase, index) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        <h3 className="text-xl font-bold text-white mb-3 break-words">{useCase.title}</h3>
                        ...
                        <ul className="space-y-2">
                          ...
                          {useCase.points.map((point, i) => (
                            ...
                            >
                              ...
                              <span className="text-gray-400 text-sm break-words">{point}</span>
                            </motion.li>
                          ))}
                        </ul>
                      </div>
              ...
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl overflow-hidden shadow-xl border border-gray-700 relative">
                ...
                <div className="p-6 text-center">
                  <motion.h3 
                    ...
                    whileInView={{ 
                      textShadow: ["0 0 0px rgba(99,102,241,0)", "0 0 15px rgba(99,102,241,0.5)", "0 0 0px rgba(99,102,241,0)"]
                    }}
                    viewport={{ once: true }}
                    transition={{ 
                      delay: 0.3,
                  ...
                  <p className="text-gray-300 break-words">
                    Watch how easy it is to create professional videos with {app.name}
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="space-y-4">
                {(app.faqs || [
                  ...
                  },
                  {
                    ...
                    answer: "Not at all! Our app is designed to be user-friendly and intuitive. You don't need any prior video editing experience or technical skills to create professional-quality content."
                  },
                  {
                    question: "How long does it take to create a video?",
                    answer: "Most videos can be created in just minutes, compared to hours or days with traditional methods. The exact time depends on the complexity of your project, but our AI-powered tools dramatically speed up the process."
                  },
                  {
                    question: "Can I use my own branding and assets?",
                    answer: "Absolutely! You can upload your logo, fonts, colors, and other brand elements to ensure your videos maintain consistent branding. You can also use your own media assets alongside our stock library."
                  },
                  {
              ...
              .map((relatedApp, index) => (
                ...
                >
                  ...
                  <motion.div 
                    ...
                    style={{ 
                      background: "linear-gradient(90deg, #6366f180, #ec489980, #6366f180)",
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-400 text-sm mb-4 break-words">{relatedApp.description}</p>
      ...
      >
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary-900/40 to-primary-700/40 rounded-xl border border-primary-500/30 p-8 text-center relative overflow-hidden">
          ...
          <MagicSparkles maxSparkles={10} minSparkles={5} minSize={5} maxSize={12}>
          ...
          <p className="text-xl text-gray-300 mb-8 break-words relative z-10">
            Join thousands of creators and businesses who have revolutionized their workflow with {app.name}.
          </p>
