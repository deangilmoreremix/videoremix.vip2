...
const BenefitsSection: React.FC = () => {
  ...
  const defaultBenefits = [
    {
      ...
      description: "Our AI tools analyze your audience and automatically personalize marketing content that resonates with each segment.",
      stats: [
        { label: "Time saved vs manual marketing personalization", value: "92%" },
    ...
    },
    {
      ...
      description: "Let AI identify and group your prospects into segments for highly targeted personalized marketing.",
      stats: [
        { label: "Increase in engagement with segmentation", value: "215%" },
        { label: "Higher conversion with personalized marketing", value: "183%" }
      ]
    },
    {
      icon: <Star className="h-10 w-10 text-primary-400" />,
      title: "Personalized Marketing That Converts",
      description: "Customize marketing to each prospect's needs, preferences, and position in the buyer journey.",
      stats: [
    ...
    },
    {
      ...
      description: "Create thousands of personalized marketing video variations without additional work using our automation tools.",
      stats: [
  ...
  const benefits = isLoading || !benefitsFeatures || benefitsFeatures.length === 0
    ? defaultBenefits 
    : benefitsFeatures.map(benefit => {
        ...
        switch(benefit.icon_name) {
          ...
          case 'Zap':
            ...
            break;
          default:
            iconComponent = <Sparkles className="h-10 w-10 text-primary-400" />;
        }
  ...
  const marketingTestimonials = [
    {
      quote: "VideoRemix makes personalized marketing so easy. The AI tools help us create segment-specific content in minutes. The platform is intuitive and powerful.",
      name: "Alex Rodriguez",
    ...
    {
      quote: "The platform has everything we need for personalized marketing. Templates are professional, the AI features save us hours, and the team collaboration tools work great.",
      name: "Sarah Johnson",
    ...
    {
      quote: "VideoRemix has become our go-to platform for all personalized marketing content. The ability to create custom content for each segment quickly is game-changing for our team.",
      name: "Michael Chen",
      role: "VP of Sales",
    ...
    {
      quote: "The VideoRemix platform streamlines our entire personalized marketing workflow. From creation to delivery, everything is in one place. Highly recommend for any marketing team.",
      name: "Emily Drake",
    ...
    {
      quote: "Our healthcare marketing campaigns now deliver custom content to patients, physicians, and administrators simultaneously. The ROI has been phenomenal with 4.2x better results.",
    ...
    {
      quote: "As an e-commerce brand, we struggled with generic marketing. Now we create dynamic product videos customized to each customer segment increasing AOV by 37%.",
      name: "Ryan Thompson",
    ...
    {
      quote: "Higher education marketing is highly competitive. Personalized video content for different prospect segments increased our application submissions by 176% year-over-year.",
      name: "Olivia Parker",
    ...
    {
      quote: "Our financial services firm now delivers personalized investment advice videos to different client segments. Client acquisition costs decreased by 58% while conversions surged.",
      name: "Daniel Morgan",
    ...
    {
      quote: "For our nonprofit, personalized donor videos based on previous giving patterns increased recurring donations by 194% and major gifts by over 300%. Game-changing technology.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300">
            Personalization isn't just a nice-to-have feature—it's the difference between marketing that converts and marketing that gets ignored.
          </p>
        </motion.div>
            ...
            >
              <div className="p-6">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2 break-words">{benefit.title}</h3>
                    <p className="text-gray-400 break-words">{benefit.description}</p>
                  </div>
                </motion.div>
                
                <div className="grid grid-cols-2 gap-4 mt-6">
                  {benefit.stats && benefit.stats.map((stat, i) => (
                    <motion.div 
                      key={i} 
                    ...
                    >
                      ...
                      >
                        <CountUp
                          ...
                          suffix={isNaN(parseInt(stat.value)) ? stat.value : ""}
                          duration={2}
                        />
                      </motion.div>
                      <div className="text-sm text-gray-500 break-words">{stat.label}</div>
                    </motion.div>
                  ))}
                </div>
              </div>
        ...
        >
          <h3 className="text-2xl font-bold text-white text-center mb-10">Success Stories</h3>
          
          {/* Navigation Arrows */}
          {marketingTestimonials.length > 1 && (
            <>
              <motion.button
                onClick={() => setActiveTestimonial((prev) => (prev === 0 ? marketingTestimonials.length - 1 : prev - 1))}
              ...
              <motion.button
                onClick={() => setActiveTestimonial((prev) => (prev + 1) % marketingTestimonials.length)}
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                      ...
                      <div className="md:w-2/3">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          ...
                          >
                            <div className="text-primary-400 font-bold text-xl">{testimonial.metrics.conversion}</div>
                          ...
                          <motion.div 
                            ...
                            whileHover={{ y: -5, borderColor: "rgba(99, 102, 241, 0.4)" }}
                          >
                            <div className="text-primary-400 font-bold text-xl">{testimonial.metrics.engagement}</div>
                          ...
                          <motion.div 
                            ...
                            whileHover={{ y: -5, borderColor: "rgba(99, 102, 241, 0.4)" }}
                          >
                            <div className="text-primary-400 font-bold text-xl">{testimonial.metrics.roi}</div>
                            <div className="text-gray-400 text-sm">Marketing ROI</div>
                          </motion.div>
                        </div>
                      </div>
                    </div>
              ...
              {marketingTestimonials.map((_, i) => (
                <motion.button
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-200 ${
                    activeTestimonial === i ? 'w-6 bg-primary-500' : 'bg-gray-600'
                  }`}
