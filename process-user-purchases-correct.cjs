...
// Function to parse a CSV line respecting quotes (handles commas inside quoted fields)
...
async function main() {
  ...
  if (args.length === 0) {
    console.log('Usage: node process-user-purchases-correct.cjs <csv-file-path>');
