...
function extractSalesCopyMap(content) {
...
function extractAppsData(content) {
...
// ExtendedSalesCopy type (simplified for JS)
const ExtendedSalesCopy = {};
...
async function generateExtendedCopy(app, tonality, openai) {
...
function generateTypeScriptExports(data) {
  const lines: string[] = [];
