...
interface OrchestrationInput {
  enter_the_company_name: string;
  enter_the_meeting_objective: string;
  enter_the_attendees_and_their_roles_one_per_line: string;
  enter_the_meeting_duration_in_minutes: string;
  enter_any_specific_areas_of_focus_or_concerns: string
  userId?: string;
}
