...
interface OrchestrationInput {
  enter_your_openai_api_key: string;
  enter_your_composio_api_key: string;
  enter_your_serpapi_key: string;
  enter_the_topic_you_want_to_learn_about: string
  userId?: string;
}
...
export async function handler(event: any) {
  ...
  try {
    ...
    await supabase.from('ai_agent_runs').insert({
      id: resultId,
      agent_type: 'ai-teaching-agent-team',
