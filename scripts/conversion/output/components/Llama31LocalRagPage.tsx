...
const Llama31LocalRagPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/llama3-1-local-rag', {
        method: 'POST',
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">AI-powered llama3 1 local rag.</p>
          </motion.div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_webpage_url">Enter Webpage URL *</Label>
                
                <Input
                  id="enter_webpage_url"
                  type="text"
                  value={formData.enter_webpage_url}
                  onChange={(e) => setFormData({ ...formData, enter_webpage_url: e.target.value })}
                  placeholder=""
              ...
              <div className="space-y-2">
                <Label htmlFor="ask_any_question_about_the_webpage">Ask any question about the webpage *</Label>
                
                <Input
                  id="ask_any_question_about_the_webpage"
                  type="text"
                  value={formData.ask_any_question_about_the_webpage}
                  onChange={(e) => setFormData({ ...formData, ask_any_question_about_the_webpage: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
