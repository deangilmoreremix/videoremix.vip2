...
const AiBreakupRecoveryAgentPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('how_are_you_feeling_what_happened', textValues.how_are_you_feeling_what_happened || '');
      formData.append('upload_screenshots_of_your_chats_optional', textValues.upload_screenshots_of_your_chats_optional || '');
      const res = await fetch('/.netlify/functions/ai-breakup-recovery-agent', {
        method: 'POST',
        body: formData
      });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Use ai-breakup-recovery-agent to automate tasks with AI." />
      </Helmet>
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">AI-powered ai breakup recovery agent.</p>
          </motion.div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="how_are_you_feeling_what_happened">How are you feeling? What happened? *</Label>
                  <Input
                    id="how_are_you_feeling_what_happened"
                    value={textValues.how_are_you_feeling_what_happened || ''}
                    onChange={(e) => setTextValues(prev => ({ ...prev, how_are_you_feeling_what_happened: e.target.value }))}
                    placeholder=""
                    className="bg-gray-900/50 border-gray-600"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="upload_screenshots_of_your_chats_optional">Upload screenshots of your chats (optional) *</Label>
                  <Input
                    id="upload_screenshots_of_your_chats_optional"
                    value={textValues.upload_screenshots_of_your_chats_optional || ''}
                    onChange={(e) => setTextValues(prev => ({ ...prev, upload_screenshots_of_your_chats_optional: e.target.value }))}
                    placeholder=""
                    className="bg-gray-900/50 border-gray-600"
                  />
                </div>
