...
const MultimodalAiAgentPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/.netlify/functions/multimodal-ai-agent', {
        method: 'POST',
        body: formData
      });
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">AI-powered multimodal ai agent.</p>
          </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setTextValues(prev => ({ ...prev, upload_image: e.target.value }))}
                    placeholder=""
                    className="bg-gray-900/50 border-gray-600"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="enter_your_taskquestion_for_the_ai_agent">Enter your task/question for the AI Agent: *</Label>
                  <Input
                    id="enter_your_taskquestion_for_the_ai_agent"
                    value={textValues.enter_your_taskquestion_for_the_ai_agent || ''}
                    onChange={(e) => setTextValues(prev => ({ ...prev, enter_your_taskquestion_for_the_ai_agent: e.target.value }))}
                    placeholder=""
                    className="bg-gray-900/50 border-gray-600"
                  />
                </div>
