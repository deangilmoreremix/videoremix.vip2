...
const 61AgentLifecycleCallbacksPage: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/6-1-agent-lifecycle-callbacks', {
        method: 'POST',
...
export default 61AgentLifecycleCallbacksPage;
