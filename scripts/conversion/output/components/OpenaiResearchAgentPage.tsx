...
const OpenaiResearchAgentPage: React.FC = () => {
  ...
  const handleSubmit = async (tabKey: string, data: any) => {
    setLoading(tabKey);
    try {
      const res = await fetch('/.netlify/functions/openai-research-agent', {
        method: 'POST',
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">AI-powered openai research agent.</p>
          </motion.div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="max-w-4xl mx-auto">
            ...
            <TabsContent value="main">
              <Card className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  <form onSubmit={(e) => { e.preventDefault(); handleSubmit('main', { enter_a_topic_to_research }); }} className="space-y-6">

                    <div className="space-y-2">
                      <Label htmlFor="enter_a_topic_to_research">Enter a topic to research:</Label>
                      <Textarea
                        id="enter_a_topic_to_research"
                        rows={3}
                        placeholder=""
            ...
            <TabsContent value="advanced">
              <Card className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  <form onSubmit={(e) => { e.preventDefault(); handleSubmit('advanced', { enter_a_topic_to_research }); }} className="space-y-6">
