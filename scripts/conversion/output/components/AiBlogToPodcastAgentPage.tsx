  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Use ai-blog-to-podcast-agent to automate tasks with AI." />
      </Helmet>
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Ai Blog To Podcast Agent</h1>
            <p className="text-xl text-gray-400">AI-powered ai blog to podcast agent.</p>
          </motion.div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_blog_url">Enter Blog URL: *</Label>
                
                <Input
                  id="enter_blog_url"
                  type="text"
                  value={formData.enter_blog_url}
                  onChange={(e) => setFormData({ ...formData, enter_blog_url: e.target.value })}
                  placeholder=""
