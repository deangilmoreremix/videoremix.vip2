...
const RagChainPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/.netlify/functions/rag-chain', {
        method: 'POST',
        body: formData
      });
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="bulb_enter_your_query_about_the_pharmaceutical_industry">:bulb: Enter your query about the Pharmaceutical Industry: *</Label>
                  <Input
                    id="bulb_enter_your_query_about_the_pharmaceutical_industry"
                    value={textValues.bulb_enter_your_query_about_the_pharmaceutical_industry || ''}
                    onChange={(e) => setTextValues(prev => ({ ...prev, bulb_enter_your_query_about_the_pharmaceutical_industry: e.target.value }))}
                    placeholder=""
                ...
                <div className="space-y-2">
                  <Label htmlFor="upload_your_research_documents_related_to_pharmaceutical_sciences_optional_memo">Upload your research documents related to Pharmaceutical Sciences (Optional) :memo: *</Label>
                  <Input
                    id="upload_your_research_documents_related_to_pharmaceutical_sciences_optional_memo"
                    value={textValues.upload_your_research_documents_related_to_pharmaceutical_sciences_optional_memo || ''}
                    onChange={(e) => setTextValues(prev => ({ ...prev, upload_your_research_documents_related_to_pharmaceutical_sciences_optional_memo: e.target.value }))}
                    placeholder=""
                    className="bg-gray-900/50 border-gray-600"
                  />
                </div>
