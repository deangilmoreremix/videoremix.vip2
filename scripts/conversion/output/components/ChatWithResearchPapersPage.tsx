...
const ChatWithResearchPapersPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/chat-with-research-papers', {
        method: 'POST',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Use chat-with-research-papers to automate tasks with AI." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_the_search_query">Enter the Search Query *</Label>
                
                <Input
                  id="enter_the_search_query"
                  type="text"
                  value={formData.enter_the_search_query}
                  onChange={(e) => setFormData({ ...formData, enter_the_search_query: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
