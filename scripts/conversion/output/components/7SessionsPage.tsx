...
const 7SessionsPage: React.FC = () => {
  ...
  const handleSubmit = async (tabKey: string, data: any) => {
    setLoading(tabKey);
    try {
      const res = await fetch('/.netlify/functions/7-sessions', {
        method: 'POST',
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="max-w-4xl mx-auto">
            ...
            <TabsContent value="main">
              <Card className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  <form onSubmit={(e) => { e.preventDefault(); handleSubmit('main', { select_demo_type, session_type, your_message, your_message, your_message, get_last_n_items, user_message_to_add, assistant_response_to_add, alice, bob, support_question, sales_inquiry, select_agent, customer_message }); }} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="get_last_n_items">Get last N items:</Label>
                      <Textarea
                        id="get_last_n_items"
                        rows={3}
                        placeholder=""
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="user_message_to_add">User message to add:</Label>
                      <Textarea
                        id="user_message_to_add"
                        rows={3}
                        placeholder=""
                        className="bg-gray-900/50 border-gray-600"
                      />
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="assistant_response_to_add">Assistant response to add:</Label>
                      <Textarea
                        id="assistant_response_to_add"
                        rows={3}
                        placeholder=""
                        className="bg-gray-900/50 border-gray-600"
                      />
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="support_question">Support question:</Label>
                      <Textarea
                        id="support_question"
                        rows={3}
                        placeholder=""
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="sales_inquiry">Sales inquiry:</Label>
                      <Textarea
                        id="sales_inquiry"
                        rows={3}
                        placeholder=""
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="select_agent">Select Agent:</Label>
                      <Textarea
                        id="select_agent"
                        rows={3}
                        placeholder=""
            ...
            <TabsContent value="advanced">
              <Card className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  <form onSubmit={(e) => { e.preventDefault(); handleSubmit('advanced', { select_demo_type, session_type, your_message, your_message, your_message, get_last_n_items, user_message_to_add, assistant_response_to_add, alice, bob, support_question, sales_inquiry, select_agent, customer_message }); }} className="space-y-6">
