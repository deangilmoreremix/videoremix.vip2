...
const 51InMemoryConversationAgentPage: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/5-1-in-memory-conversation-agent', {
        method: 'POST',
...
export default 51InMemoryConversationAgentPage;
