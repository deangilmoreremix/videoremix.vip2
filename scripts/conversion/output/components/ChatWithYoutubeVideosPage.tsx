...
const ChatWithYoutubeVideosPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/chat-with-youtube-videos', {
        method: 'POST',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Use chat-with-youtube-videos to automate tasks with AI." />
      </Helmet>
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Chat With Youtube Videos</h1>
            <p className="text-xl text-gray-400">AI-powered chat with youtube videos.</p>
          </motion.div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_youtube_video_url">Enter YouTube Video URL *</Label>
                
                <Input
                  id="enter_youtube_video_url"
                  type="text"
                  value={formData.enter_youtube_video_url}
                  onChange={(e) => setFormData({ ...formData, enter_youtube_video_url: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
              ...
              <div className="space-y-2">
                <Label htmlFor="ask_any_question_about_the_youtube_video">Ask any question about the YouTube Video *</Label>
                
                <Input
                  id="ask_any_question_about_the_youtube_video"
                  type="text"
                  value={formData.ask_any_question_about_the_youtube_video}
                  onChange={(e) => setFormData({ ...formData, ask_any_question_about_the_youtube_video: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
