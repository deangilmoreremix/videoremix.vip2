...
const LlmAppPersonalizedMemoryPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/llm-app-personalized-memory', {
        method: 'POST',
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_your_username">Enter your Username *</Label>
                
                <Input
                  id="enter_your_username"
                  type="text"
                  value={formData.enter_your_username}
                  onChange={(e) => setFormData({ ...formData, enter_your_username: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
              ...
              <div className="space-y-2">
                <Label htmlFor="ask_chatgpt">Ask ChatGPT *</Label>
                
                <Input
                  id="ask_chatgpt"
                  type="text"
                  value={formData.ask_chatgpt}
                  onChange={(e) => setFormData({ ...formData, ask_chatgpt: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
