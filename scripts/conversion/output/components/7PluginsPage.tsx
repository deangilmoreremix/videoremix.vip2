...
const 7PluginsPage: React.FC = () => {
  const { user } = useAuth();
  const [formData, setFormData] = useState({ choose_a_test_scenario: "", or_enter_your_own_message: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/7-plugins', {
        method: 'POST',
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">AI-powered 7 plugins.</p>
          </motion.div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="choose_a_test_scenario">Choose a test scenario: *</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="or_enter_your_own_message">Or enter your own message: *</Label>
                
                <Textarea
                  id="or_enter_your_own_message"
                  value={formData.or_enter_your_own_message}
                  onChange={(e) => setFormData({ ...formData, or_enter_your_own_message: e.target.value })}
                  placeholder=""
