...
const AiTeachingAgentTeamPage: React.FC = () => {
  const { user } = useAuth();
  const [formData, setFormData] = useState({ enter_your_openai_api_key: "", enter_your_composio_api_key: "", enter_your_serpapi_key: "", enter_the_topic_you_want_to_learn_about: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/ai-teaching-agent-team', {
        method: 'POST',
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">AI-powered ai teaching agent team.</p>
          </motion.div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_your_composio_api_key">Enter your Composio API Key *</Label>
                
                <Input
                  id="enter_your_composio_api_key"
                  type="text"
                  value={formData.enter_your_composio_api_key}
                  onChange={(e) => setFormData({ ...formData, enter_your_composio_api_key: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_your_serpapi_key">Enter your SerpAPI Key *</Label>
                
                <Input
                  id="enter_your_serpapi_key"
                  type="text"
                  value={formData.enter_your_serpapi_key}
                  onChange={(e) => setFormData({ ...formData, enter_your_serpapi_key: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
              ...
              <div className="space-y-2">
                <Label htmlFor="enter_the_topic_you_want_to_learn_about">Enter the topic you want to learn about: *</Label>
                
                <Input
                  id="enter_the_topic_you_want_to_learn_about"
                  type="text"
                  value={formData.enter_the_topic_you_want_to_learn_about}
                  onChange={(e) => setFormData({ ...formData, enter_the_topic_you_want_to_learn_about: e.target.value })}
                  placeholder=""
                  className="bg-gray-900/50 border-gray-600 text-white"
                />
