...
const ProductLaunchIntelligenceAgentPage: React.FC = () => {
  ...
  const handleSubmit = async (tabKey: string, data: any) => {
    setLoading(tabKey);
    try {
      const res = await fetch('/.netlify/functions/product-launch-intelligence-agent', {
        method: 'POST',
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">AI-powered product launch intelligence agent.</p>
          </motion.div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="max-w-4xl mx-auto">
            ...
            <TabsContent value="main">
              <Card className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  <form onSubmit={(e) => { e.preventDefault(); handleSubmit('main', { openai_api_key, firecrawl_api_key }); }} className="space-y-6">
            ...
            <TabsContent value="advanced">
              <Card className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  <form onSubmit={(e) => { e.preventDefault(); handleSubmit('advanced', { openai_api_key, firecrawl_api_key }); }} className="space-y-6">
