...
const AiAqiAnalysisAgentPage: React.FC = () => {
  const { user } = useAuth();
  const [formData, setFormData] = useState({ firecrawl_api_key: "", openai_api_key: "", city: "", state: "", country: "", medical_conditions_optional: "", planned_activity: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const res = await fetch('/.netlify/functions/ai-aqi-analysis-agent', {
        method: 'POST',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Use ai-aqi-analysis-agent to automate tasks with AI." />
      </Helmet>
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Ai Aqi Analysis Agent</h1>
            <p className="text-xl text-gray-400">AI-powered ai aqi analysis agent.</p>
          </motion.div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 mb-8">
            ...
            <CardContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="medical_conditions_optional">Medical Conditions (optional) *</Label>
                
                <Textarea
                  id="medical_conditions_optional"
                  value={formData.medical_conditions_optional}
                  onChange={(e) => setFormData({ ...formData, medical_conditions_optional: e.target.value })}
                  placeholder=""
              ...
              <div className="space-y-2">
                <Label htmlFor="planned_activity">Planned Activity *</Label>
